...
if (amysAge > brittanisAge){
  ...
  console.log(' Amy and Brittani has the same age')
}
...
if ( temperature >= 80 && rain === true){
  ...
  console.log(' You should wear a jacket and heavy sweater')
}
...
while (score < passingScore){
  ...
  if (score === passingScore){
    console.log(" You are log 7 times")
  }
  score ++
}
